                    ...
                    else
                    {
                        ...
                        if (!obj.Help)
                        {
                            if (obj.Status == 1) //Wait
                            {
                                ...
                                {
                                    if (obj.StatusContinueTime.CompareTo(ConvertTimeHHMMSS(StatusOverTime1)) >= 0)
                                ...
                                {
                                    //if (obj.StatusContinueTime.CompareTo("00:" + StatusOverTime2 + ":00") >= 0) //item.BackColor = Color.LightPink; //Color.Red;
                                    if (obj.StatusContinueTime.CompareTo(ConvertTimeHHMMSS(StatusOverTime2)) >= 0) //item.BackColor = Color.LightPink; //Color.Red;
                            ...
                            else if (obj.Status == 5) //WorkTime
                            {
                                ...
                                {
                                    //if (obj.StatusContinueTime.CompareTo("00:" + StatusOverTime3 + ":00") >= 0) // item.BackColor = Color.LightYellow;//Color.Yellow;
                                    if (obj.StatusContinueTime.CompareTo(ConvertTimeHHMMSS(StatusOverTime3)) >= 0) // item.BackColor = Color.LightYellow;//Color.Yellow;
                                        item.BackColor = Color.LightYellow;
                                }
                                if (StatusOverTime4 != "000")
                                {
                                    //if (obj.StatusContinueTime.CompareTo("00:" + StatusOverTime4 + ":00") >= 0) //item.BackColor = Color.LightPink; //Color.Red;
                                    if (obj.StatusContinueTime.CompareTo(ConvertTimeHHMMSS(StatusOverTime4)) >= 0) //item.BackColor = Color.LightPink; //Color.Red;
                                        item.BackColor = Color.LightPink;
                                }
                            }
                            else if (obj.Status == 6) //SeatOff
                            {
                                ...
                                {
                                    //if (obj.StatusContinueTime.CompareTo("00:" + StatusOverTime5 + ":00") >= 0) //item.BackColor = Color.Yellow;
                                    if (obj.StatusContinueTime.CompareTo(ConvertTimeHHMMSS(StatusOverTime5)) >= 0) //item.BackColor = Color.Yellow;
                                        item.BackColor = Color.LightYellow;
                                }
                                if (StatusOverTime6 != "000")
                                {
                                    //if (obj.StatusContinueTime.CompareTo("00:" + StatusOverTime6 + ":00") >= 0) //item.BackColor = Color.Red;
                                    if (obj.StatusContinueTime.CompareTo(ConvertTimeHHMMSS(StatusOverTime6)) >= 0) //item.BackColor = Color.Red;
                                        item.BackColor = Color.LightPink;
                                }
                            }
                            else if (obj.Status == 10) //Tel
                            {
                                ...
                                {
                                    //if (obj.StatusContinueTime.CompareTo("00:" + StatusOverTime7 + ":00") >= 0) //item.BackColor = Color.Yellow;
                                    if (obj.StatusContinueTime.CompareTo(ConvertTimeHHMMSS(StatusOverTime7)) >= 0) //item.BackColor = Color.Yellow;
                                        item.BackColor = Color.LightYellow;
                                }
                                if (StatusOverTime8 != "000")
                                {
                                    //if (obj.StatusContinueTime.CompareTo("00:" + StatusOverTime8 + ":00") >= 0) //item.BackColor = Color.Red;
                                    if (obj.StatusContinueTime.CompareTo(ConvertTimeHHMMSS(StatusOverTime8)) >= 0) //item.BackColor = Color.Red;
                                        item.BackColor = Color.LightPink;
                                }
                            }
                            else if (obj.Status == 30) //Hold
                            {
                                ...
                                {
                                    //if (obj.StatusContinueTime.CompareTo("00:" + StatusOverTime9 + ":00") >= 0) //item.BackColor = Color.Yellow;
                                    if (obj.StatusContinueTime.CompareTo(ConvertTimeHHMMSS(StatusOverTime9)) >= 0) //item.BackColor = Color.Yellow;
                                        item.BackColor = Color.LightYellow;
                                }
                                if (StatusOverTime10 != "000")
                                {
                                    //if (obj.StatusContinueTime.CompareTo("00:" + StatusOverTime10 + ":00") >= 0) //item.BackColor = Color.Red;
                                    if (obj.StatusContinueTime.CompareTo(ConvertTimeHHMMSS(StatusOverTime10)) >= 0) //item.BackColor = Color.Red;
                                        item.BackColor = Color.LightPink;
                                }
                            }
                        }
